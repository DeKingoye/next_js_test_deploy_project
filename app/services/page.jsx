...
import {MdOutlineArrowOutward, MdOutRightAlt, MdArrowRightAlt} from "react-icons/md"; 
          ...
          <div className='container mx-auto w-full flex flex-col gap-16'>
            ...
            <div className='flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8'> 
              ...
              <h2 className='h2 max-w-[480px] text-left xl:mb-0'>
                Custom <span className='text-accent'>Solution Web</span> 
                to Boost Your Business
              </h2>
              {/* btn */}
              <button className='btn btn-lg btn-accent flex gap-2'>
                tous les services <MdArrowRightAlt className="text-2xl"/> 
              </button>
            </div>
            {/* slider */}
            <Swiper 
